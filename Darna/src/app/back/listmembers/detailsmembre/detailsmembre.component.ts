...
export class DetailsmembreComponent implements OnInit {
  ...
  pdm;
  constructor( private router: Router,private route: ActivatedRoute , private listMemberService: ListMemberService,private SpinnerService: NgxSpinnerService) { }
  ...
  bannirMember(id){
    Swal.fire({
      ...
      if (result.value) {
        ...
        Swal.fire(
          'Supprimé',
          'Ce Member a été banni avec succés',
          'success'
        );
      }
    });
